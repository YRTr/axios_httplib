...
function updateTodo() {
  axios
    .put('https://jsonplaceholder.typicode.com/photos/1', {
      title: 'updated pic',
      url: 'http://www.updatedone.in/600'
    })
    .then(res => showOutput(res))
    .catch(err => console.log(err));
}
...
function removeTodo() {
  axios
    .delete('https://jsonplaceholder.typicode.com/photos/2')
    .then(res => showOutput(res))
    .catch(err => console.log(err));
}
